...
const GlobalSearch = () => {
    ...
    return (
        <div className='flex items-center justify-between bg-white px-4 gap-x-2 rounded-full border border-transparent focus-within:border focus-within:border-indigo-500 focus-within:ring-indigo-500 focus-within:ring-1'>
