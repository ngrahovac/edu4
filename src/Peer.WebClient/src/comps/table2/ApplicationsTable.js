...
ApplicationsTable.Footer.Cell = ({ children, collspan = 1 }) => <td colSpan={collspan} className='text-left p-4 h-12 uppercase tracking-wider text-slate-400 text-sm font-medium'>
    {children}
</td>
