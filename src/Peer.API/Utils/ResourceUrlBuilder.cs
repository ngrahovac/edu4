...
{
    public static string BuildProjectUrl(Guid projectId) => $"projects/{projectId}";

    public static string BuildPositionUrl(Guid projectId, Guid positionId) =>
        $"projects/{projectId}/positions/{positionId}";

    public static string BuildContributorUrl(Guid contributorId) => $"contributors/{contributorId}";
